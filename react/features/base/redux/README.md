Gedui Vox - redux state persistence
====================================
Gedui Vox has a persistence layer that persists specific subtrees of the redux
...
When it's done, Gedui Vox will automatically persist these subtrees and
